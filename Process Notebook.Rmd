...
```{r}
# merged_trips[,c("start_station_name")][merged_trips$start_station_name == ""] <- station_by_geo(merged_trips[,c("start_lat")][merged_trips$start_station_name == ""],merged_trips[,c("start_lng")][merged_trips$start_station_name == ""])["name"]
```
...
# test3 <- merged_trips[,c("ride_id","start_station_name")][merged_trips$start_station_name == "",]
