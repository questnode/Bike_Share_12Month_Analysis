...
folder_path <- "C:\\Users\\rayyao\\Documents\\Case Study 1\\Analysis\\rawdata" #File path to the folder with the *.csv files
output_file <- "C:\\Users\\rayyao\\Documents\\Case Study 1\\Analysis\\ETL\\tripdata_202111-202210.csv" #File path + file name for the resulting file
